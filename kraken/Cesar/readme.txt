...
4) se deben copiar los archivos : Invitar_Nuevo_Usuario.js,  Crear_Integracion.js, Crear_Tag.js, Editar_Publicar_Tag.js, Borrar_Tag.js en la carpeta integration
   del proyecto.
3) se debe ejecutar las pruebas de la siguiente forma desde la raiz del proyecto ejemplo
