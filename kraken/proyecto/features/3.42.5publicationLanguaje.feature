Feature: Cambiar configuraciones del sitio
  ...
  @user1 @web
  Scenario: Cambiar el idioma de publicacion
    ...
    Then I click on element having css selector ".gh-setting-last .gh-setting-action"
    Then I clear text having class ".ember-text-field.gh-input.ember-view"
    Then I enter "es" into input field having css selector ".ember-text-field.gh-input.ember-view"
