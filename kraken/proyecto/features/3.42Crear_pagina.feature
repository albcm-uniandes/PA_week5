 ...
 @user1 @web
  Scenario: Crear pagina y publicarla
	...
	Then I enter "Contenido " into input field having css selector "p"
	Then I enter "Contenido 1" into input field having css selector "p"
	Then I enter "Contenido 2" into input field having css selector "p"
