Feature: Search unexistent post
    Background:
    ...
    Scenario: As logged user I want to search an unexistent post
        ...
        * I enter "__RESOURCE_NOT_FOUND__" into input field having css selector ".gh-nav-search-input .ember-power-select-trigger input"
